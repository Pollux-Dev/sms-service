...
import { CustomersSearch } from '@/scenes/Send/customers-search';
import { CustomersTable } from '@/scenes/Send/customers-table';
...
const TableView = ({ userData, onBack }: PropsType) => {
